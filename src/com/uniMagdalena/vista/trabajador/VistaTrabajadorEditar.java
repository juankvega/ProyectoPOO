...
import com.uniMagdalena.controlador.trabajador.TrabajadorControladorEditar;
...
public class VistaTrabajadorEditar extends SubScene
{
    ...
    private final TrabajadorDto objTrabajador;
    
    private Pane panelCuerpo;
    private final BorderPane panelPrincipal;
    
    public VistaTrabajadorEditar(Stage ventanaPadre, BorderPane princ, Pane pane, double ancho, double alto, TrabajadorDto objTrabajadorExterno, int posicionArchivo )
    {
        ...
        objTrabajador = objTrabajadorExterno;
    ...
    private void PintarFormulario()
    {
        ...
        cajaNombre.setText(objTrabajador.getNombreTrabajador());
        ...
        if(objTrabajador.getGeneroTrabajador())
        {
        ...
        cajaImagen.setText(objTrabajador.getNombreImagenPublicoTrabajador());
...
{   
    ...
    if (rutaSeleccionada != null && !rutaSeleccionada.isEmpty()) {
        ...
        imgPorDefecto = Icono.obtenerIconoExterno(objTrabajador.getNombreImagenPrivadoTrabajador(), 150);
        GridPane.setHalignment(imgPorDefecto, HPos.CENTER);
        GridPane.setValignment(imgPorDefecto, VPos.CENTER);
        miGrilla.add(imgPorDefecto, 2, 1, 1, 3);
        ...
        choiceTipoDocumento.setValue(objTrabajador.getTipoDocumentoTrabajador());
        ...
        String numeroDocumento = String.valueOf(objTrabajador.getNumDocumentoTrabajador());
        ...
        Button btnGrabar = new Button("Actualizar el trabajador");
        ...
        btnRegresar.setMaxWidth(Long.MAX_VALUE);
        ...
        btnRegresar.setOnAction((ActionEvent e) -> {
            panelCuerpo = TrabajadorControladorVentana.administrar(
    ...
    private void seleccionTipoTrabajador()
    {
        String tipoTrabajador = objTrabajador.getTipoTrabajador();
        ...
        switch(tipoTrabajador)
        {
            ...
            case "Cajero":
                ...
                break;
            case "Confitero":
                rbConfitero.setSelected(true);
                break;
            case "Vigilante":
                rbVigilante.setSelected(true);
                break;
        }
    }
    ...
    private void grabarTrabajador()
    {
        if(formularioValido())
        {
            ...
            int codTrabajador = objTrabajador.getIdTrabajador();
            String nomTrabajador = cajaNombre.getText();
            Boolean genTrabajador = obtenerEstadoCombo();
            String tipoDocTrabajador = choiceTipoDocumento.getValue();
            Long numDocTrabajador = numeroDocumento;
