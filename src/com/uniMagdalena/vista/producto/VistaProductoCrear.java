...
import com.uniMagdalena.controlador.producto.ProductoControladorGrabar;
...
public class VistaProductoCrear extends SubScene
{
    ...
    private PasswordField cajaPrecio; // CORREGIDO: Cambiado de PasswordField a TextField
    ...
    public VistaProductoCrear(Stage esce, double ancho, double alto)
    {
    ...
    {
        Text titulo = new Text("Formulario creación de producto");
    ...
    private void limpiarFormulario()
    {
        ...
        // CORREGIDO: Agregado clearSelection para el tamaño
    ...
    private Boolean formularioValido()
    {
        ...
        try
        {
           ...
           if(numero2 <= 0 || numero.length() < 1)
           {
               Mensaje.mostrar(Alert.AlertType.WARNING, null, "ERROR", "EL Precio debe ser un numero Positivo mayor a 0" );
    ...
    private void grabarProducto()
    {
        if(formularioValido())
        {
            ...
            dto.setNombreProducto(cajaNombre.getText());
            dto.setTipoProducto(obtenerEstadoCombo());
            dto.setTamanioProducto(choiceTamanioProducto.getValue());
            dto.setPrecioProducto(numeroCajaPrecio);
            dto.setNombreImagenPublicoProducto(cajaImagen.getText());
            
            if(ProductoControladorGrabar.crearProducto(dto, rutaSeleccionada))
            {
