...
public class VistaClienteCrear extends SubScene
{
    ...
    private void limpiarFormulario()
    {
        ...
        grupoTipoCliente.getSelectedToggle().setSelected(false);
    ...
    private void grabarCliente()
    {
        if(formularioValido())
        {
            ...
            dto.setTipoDocumentoCliente(choiceTipoDocumento.getValue());
            dto.setNumeroDocumentoCliente(numeroDocumento);
            dto.setTipoCliente(obtenerTipoCliente());
            dto.setNombreImagenPublicoCliente(cajaImagen.getText());
            
            if(ClienteControladorGrabar.crearCliente(dto, rutaSeleccionada))
            {
