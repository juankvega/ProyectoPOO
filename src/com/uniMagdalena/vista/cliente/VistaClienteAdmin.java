...
public class VistaClienteAdmin extends SubScene
{
    ...
    public VistaClienteAdmin(Stage ventanaPadre, BorderPane princ, Pane pane ,double ancho, double alto)
    {
    ...
    private TableColumn<ClienteDto, String> crearColumnaImagen()
    {
        ...
        columna.setCellFactory(column -> new TableCell<ClienteDto, String>()
        {
    ...
    private void mostrarIconosAdministrar()
    {
        ...
        else
        {
            ...
            msg2 = "\n número docuemnto: "+objCliente.getNumeroDocumentoCliente();
            ...
            if(mensajito.showAndWait().get() == ButtonType.OK)
            {
                ...
                if(ClienteControladorEliminar.borrar(fila))
                {
                    int cant = ClienteControladorListar.cantidadClientes();
                    miTitulo.setText("Administrador de Clientes - ("+ cant + ")");
                    List<ClienteDto> quedaron =  ClienteControladorListar.arregloClientes();
        ...
        btnActualizar.setOnAction((ActionEvent e) -> 
        {
            ...
            if (miTabla.getSelectionModel().getSelectedItem() == null) {
                ...
                }else
                {
                    ...
                    panelCuerpo = ClienteControladorVentana.editar(laVentanaPrincipal, panelPrincipal, panelCuerpo, Configuracion.ANCHO_APP, Configuracion.ALTO_APP, objCliente, posicion);
