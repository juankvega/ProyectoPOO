...
public class VistaSalaCrear extends SubScene
{
   ...
   private ComboBox<SedeDto> cbmSedes;
    ...
    private void PintarFormulario()
    {
        ...
        cajaNombre.setPromptText("Nombre que identifica la sala");
        ...
        Button btnGrabar = new Button("Clic para Grabar");
    ...
    private void grabarSala()
    {
        if(formularioValido())
        {
            ...
            dto.setAsientosSala(cantidadAsientos);
            dto.setSala4d(obtenerResultadoSwitch());
            dto.setSedeSala(obtenerResultadoComboSede());
